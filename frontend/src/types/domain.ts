...
export interface Alert { id: number; greenhouseId: number; sensorId: number; level: string; message: string; value: number; status: string; occurrenceCount: number; createdAt: string; acknowledgedAt?: string; recoveredAt?: string; recoveredValue?: number; handledAt?: string; sensor?: Sensor; }
