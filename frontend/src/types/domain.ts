...
export interface Alert { id: number; greenhouseId: number; sensorId: number; level: string; message: string; value: number; count: number; status: string; createdAt: string; updatedAt?: string; handledAt?: string; recoveredAt?: string; recoveredValue?: number; sensor?: Sensor; }
